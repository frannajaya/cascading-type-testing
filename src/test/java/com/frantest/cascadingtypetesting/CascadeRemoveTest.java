...
public class CascadeRemoveTest {
    ...
    @Test
    @Order(5)
    public void testCarIsDeleted() {
        Car fromDb = carRepository.getCarBySeries("A1A");

        // then
        assertTrue("Error car still exists", fromDb == null);
    }

    @Test
    @Order(6)
    public void testSteeringWheelIsDeleted() {
        SteeringWheel fromDb = steeringWheelRepository.getSteeringWheelByDiameters(35);

        // then
        assertTrue("Error steering wheel still exists", fromDb == null);
    }
}
